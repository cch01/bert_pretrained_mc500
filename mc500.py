...
if __name__ == "__main__":
  ...
  passages, questions, options, answer_data = readMcTest('./data/MCTest/', ['mc500.train.tsv', 'mc500.dev.tsv', 'mc500.test.tsv','mc160.train.tsv', 'mc160.dev.tsv', 'mc160.test.tsv'], ['mc500.train.ans', 'mc500.dev.ans', 'mc500.test.ans','mc160.train.ans', 'mc160.dev.ans', 'mc160.test.ans'])
